...
func ListCalendars(pageSize int, pageToken string) ([]*Calendar, string, bool, error) {
	...
	resp, err := client.Calendar.Calendar.List(Context(), reqBuilder.Build(), tokenOpt)
	if err != nil {
...
func CreateEvent(params *CreateEventParams) (*CalendarEvent, error) {
	...
	resp, err := client.Calendar.CalendarEvent.Create(Context(), req, tokenOpt)
	if err != nil {
...
func GetEvent(calendarID, eventID string) (*CalendarEvent, error) {
	...
	resp, err := client.Calendar.CalendarEvent.Get(Context(), req, tokenOpt)
	if err != nil {
...
func ListEvents(params *ListEventsParams) ([]*CalendarEvent, string, bool, error) {
	...
	resp, err := client.Calendar.CalendarEvent.List(Context(), reqBuilder.Build(), tokenOpt)
	if err != nil {
...
func UpdateEvent(params *UpdateEventParams) (*CalendarEvent, error) {
	...
	resp, err := client.Calendar.CalendarEvent.Patch(Context(), req, tokenOpt)
	if err != nil {
...
func DeleteEvent(calendarID, eventID string) error {
	...
	resp, err := client.Calendar.CalendarEvent.Delete(Context(), req, tokenOpt)
	if err != nil {
...
func GetCalendar(calendarID string) (*Calendar, error) {
	...
	resp, err := client.Calendar.Calendar.Get(Context(), req, tokenOpt)
	if err != nil {
...
func GetPrimaryCalendar() (*Calendar, error) {
	...
	resp, err := client.Calendar.Calendar.Primary(Context(), req, tokenOpt)
	if err != nil {
...
func SearchEvents(calendarID, query string, startTime, endTime string, pageToken string, pageSize int) ([]*CalendarEvent, string, error) {
	...
	resp, err := client.Calendar.CalendarEvent.Search(Context(), reqBuilder.Build(), tokenOpt)
	if err != nil {
...
func AddEventAttendees(calendarID, eventID string, attendees []*EventAttendee) error {
	...
	resp, err := client.Calendar.CalendarEventAttendee.Create(Context(), req, tokenOpt)
	if err != nil {
...
func ListEventAttendees(calendarID, eventID string, pageSize int, pageToken string) ([]*EventAttendee, string, bool, error) {
	...
	resp, err := client.Calendar.CalendarEventAttendee.List(Context(), reqBuilder.Build(), tokenOpt)
	if err != nil {
...
func ListFreebusy(startTime, endTime string, userID string) ([]*FreebusyInfo, error) {
	...
	resp, err := client.Calendar.Freebusy.List(Context(), req, tokenOpt)
	if err != nil {
...
func ReplyEvent(calendarID, eventID, rsvpStatus string) error {
	...
	resp, err := client.Calendar.CalendarEvent.Reply(Context(), req, tokenOpt)
	if err != nil {
