...
func CreateTask(opts CreateTaskOptions) (*TaskInfo, error) {
	...
	resp, err := client.Task.V2.Task.Create(Context(), req, tokenOpt)
	if err != nil {
...
func GetTask(taskGuid string) (*TaskInfo, error) {
	...
	resp, err := client.Task.V2.Task.Get(Context(), req, tokenOpt)
	if err != nil {
...
func ListTasks(pageSize int, pageToken string, completed *bool) (*ListTasksResult, error) {
	...
	resp, err := client.Task.V2.Task.List(Context(), req, tokenOpt)
	if err != nil {
...
func UpdateTask(taskGuid string, opts UpdateTaskOptions) (*TaskInfo, error) {
	...
	resp, err := client.Task.V2.Task.Patch(Context(), req, tokenOpt)
	if err != nil {
...
func DeleteTask(taskGuid string) error {
	...
	resp, err := client.Task.V2.Task.Delete(Context(), req, tokenOpt)
	if err != nil {
...
func CreateSubtask(taskGuid, summary string) (*TaskInfo, error) {
	...
	resp, err := client.Task.V2.TaskSubtask.Create(Context(), req, tokenOpt)
	if err != nil {
...
func ListSubtasks(taskGuid string, pageSize int, pageToken string) ([]*TaskInfo, string, bool, error) {
	...
	resp, err := client.Task.V2.TaskSubtask.List(Context(), reqBuilder.Build(), tokenOpt)
	if err != nil {
...
func AddTaskMembers(taskGuid string, memberIDs []string, memberRole string) error {
	...
	resp, err := client.Task.V2.Task.AddMembers(Context(), req, tokenOpt)
	if err != nil {
...
func RemoveTaskMembers(taskGuid string, memberIDs []string, memberRole string) error {
	...
	resp, err := client.Task.V2.Task.RemoveMembers(Context(), req, tokenOpt)
	if err != nil {
...
func AddTaskReminders(taskGuid string, relativeFireMinute int) error {
	...
	resp, err := client.Task.V2.Task.AddReminders(Context(), req, tokenOpt)
	if err != nil {
...
func RemoveTaskReminders(taskGuid string, reminderIDs []string) error {
	...
	resp, err := client.Task.V2.Task.RemoveReminders(Context(), req, tokenOpt)
	if err != nil {
...
func CreateTasklist(name string) (*TasklistInfo, error) {
	...
	resp, err := client.Task.V2.Tasklist.Create(Context(), req, tokenOpt)
	if err != nil {
...
func GetTasklist(tasklistGuid string) (*TasklistInfo, error) {
	...
	resp, err := client.Task.V2.Tasklist.Get(Context(), req, tokenOpt)
	if err != nil {
...
func ListTasklists(pageSize int, pageToken string) ([]*TasklistInfo, string, bool, error) {
	...
	resp, err := client.Task.V2.Tasklist.List(Context(), reqBuilder.Build(), tokenOpt)
	if err != nil {
...
func DeleteTasklist(tasklistGuid string) error {
	...
	resp, err := client.Task.V2.Tasklist.Delete(Context(), req, tokenOpt)
	if err != nil {
